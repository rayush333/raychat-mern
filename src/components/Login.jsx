...
function Login(){
    ...
    return <div className="login">
        <div class="login-container">
            ...
            <Button type="submit" onClick={handleSubmitFB}>
                Sign In with FB
            </Button>
        </div>
    </div>;
